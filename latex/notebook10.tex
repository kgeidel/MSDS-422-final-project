...
\begin{table}[h]
    \centering
    \begin{tabular}{c}
    Listing 1: Python code and output from Module10\_Geidel.ipynb \\
    \hline
    \end{tabular}
    \end{table}
...
\PY{c+c1}{\PYZsh{} Module 10 \PYZhy{} Final project}

\PY{c+c1}{\PYZsh{} IsWine Binary Classifier}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{notebook10_files/notebook10_10_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{notebook10_files/notebook10_12_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \clearpage 
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
...
\end{tcolorbox}
    \vspace{1in}
    \begin{center}
    \adjustimage{max size={0.8\linewidth}{0.8\paperheight}}{notebook10_files/notebook10_13_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.8\linewidth}{0.8\paperheight}}{notebook10_files/notebook10_13_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.8\linewidth}{0.8\paperheight}}{notebook10_files/notebook10_13_2.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{notebook10_files/notebook10_14_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    \clearpage
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{notebook10_files/notebook10_16_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
37         2.43                  0.29             1.44             4.25  1.12
     ...
     OD280/OD315\_of\_diluted\_wines  Proline  color\_per\_flavanoid  log\_flavanoid
29                           3.59   1035.0             2.017167       0.845868
16                           2.65   1280.0             1.974522       1.144223
147                          1.86    625.0            11.769231      -0.430783
97                           2.74    428.0             1.160000       0.916291
159                          1.78    620.0            10.681818       0.095310
..                            {\ldots}      {\ldots}                  {\ldots}            {\ldots}
133                          1.29    600.0             4.166667       0.182322
137                          1.69    515.0             8.333333      -0.510826
72                           2.78    472.0             2.032609       0.609766
140                          2.31    600.0             9.200000      -0.693147
37                           2.51   1105.0             1.748971       0.887891
...
159                                 -1.135004            -0.403087
     ...
     pipeline-1\_\_color\_per\_flavanoid  pipeline-1\_\_log\_flavanoid
29                         -0.498390                   0.515697
16                         -0.508292                   0.992637
147                         1.766075                  -1.525116
97                         -0.697428                   0.628272
159                         1.513574                  -0.684120
\end{Verbatim}
\end{tcolorbox}
\clearpage    
    \hypertarget{deployment-model-selection-evaluation}{%
\paragraph{Deployment: Model selection \&
evaluation}\label{deployment-model-selection-evaluation}}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{20}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Model number 1 is an SGDClassifier}

\PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{linear\PYZus{}model} \PY{k+kn}{import} \PY{n}{SGDClassifier}

\PY{n}{sgd\PYZus{}clf} \PY{o}{=} \PY{n}{SGDClassifier}\PY{p}{(}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{422}\PY{p}{)}
\PY{n}{sgd\PYZus{}clf}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{training\PYZus{}data\PYZus{}cleaned\PYZus{}df}\PY{p}{,} \PY{n}{training\PYZus{}labels}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
SGDClassifier(random\_state=422)
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Model number 2 will be a RandomForestClassifier}

\PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{ensemble} \PY{k+kn}{import} \PY{n}{RandomForestClassifier}

\PY{n}{forest\PYZus{}clf} \PY{o}{=} \PY{n}{RandomForestClassifier}\PY{p}{(}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{422}\PY{p}{)}
\PY{n}{forest\PYZus{}clf}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{training\PYZus{}data\PYZus{}cleaned\PYZus{}df}\PY{p}{,} \PY{n}{training\PYZus{}labels}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
RandomForestClassifier(random\_state=422)
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Model number 3 will be a SVM}

\PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{svm} \PY{k+kn}{import} \PY{n}{SVC}

\PY{n}{svm\PYZus{}clf} \PY{o}{=} \PY{n}{SVC}\PY{p}{(}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{422}\PY{p}{)}
\PY{n}{svm\PYZus{}clf}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{training\PYZus{}data\PYZus{}cleaned\PYZus{}df}\PY{p}{,} \PY{n}{training\PYZus{}labels}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Model number 4 will be a K\PYZhy{}Neighbors Classifier}

\PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{neighbors} \PY{k+kn}{import} \PY{n}{KNeighborsClassifier}

\PY{n}{knn\PYZus{}clf} \PY{o}{=} \PY{n}{KNeighborsClassifier}\PY{p}{(}\PY{n}{n\PYZus{}neighbors}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}
\PY{n}{knn\PYZus{}clf}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{training\PYZus{}data\PYZus{}cleaned\PYZus{}df}\PY{p}{,} \PY{n}{training\PYZus{}labels}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Let\PYZsq{}s evaluate our four models on the test data.}

\PY{n}{test\PYZus{}y} \PY{o}{=} \PY{n}{test\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{isWine}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\PY{n}{test\PYZus{}x} \PY{o}{=} \PY{n}{preprocessing}\PY{o}{.}\PY{n}{fit\PYZus{}transform}\PY{p}{(}\PY{n}{test\PYZus{}data}\PY{o}{.}\PY{n}{drop}\PY{p}{(}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{isWine}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{binaryClass}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
\PY{n}{test\PYZus{}x} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}
    \PY{n}{test\PYZus{}x}\PY{p}{,}
    \PY{n}{columns}\PY{o}{=}\PY{n}{preprocessing}\PY{o}{.}\PY{n}{get\PYZus{}feature\PYZus{}names\PYZus{}out}\PY{p}{(}\PY{p}{)}\PY{p}{,}
    \PY{n}{index}\PY{o}{=}\PY{n}{test\PYZus{}data}\PY{o}{.}\PY{n}{index}
\PY{p}{)}
...
53                                   0.284604             1.652101
     ...
     pipeline-1\_\_color\_per\_flavanoid  pipeline-1\_\_log\_flavanoid
161                         2.436004                  -2.187141
117                        -0.708457                   0.111771
19                         -0.477928                   0.760081
69                         -0.298338                  -0.744099
53                         -0.287927                   0.616033
\end{Verbatim}
\end{tcolorbox}
...
\PY{c+c1}{\PYZsh{} Evaluate model \PYZsh{}1...}

\PY{n}{sgd\PYZus{}preds} \PY{o}{=} \PY{n}{sgd\PYZus{}clf}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{test\PYZus{}x}\PY{p}{)}

\PY{n}{sgd\PYZus{}metrics} \PY{o}{=} \PY{n+nb}{dict}\PY{p}{(}
    \PY{n}{model} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Stochastic Gradient Descent}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{n}{accuracy} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{cross\PYZus{}val\PYZus{}score}\PY{p}{(}
        \PY{n}{sgd\PYZus{}clf}\PY{p}{,} \PY{n}{test\PYZus{}x}\PY{p}{,} \PY{n}{test\PYZus{}y}\PY{p}{,} 
        \PY{n}{cv}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{scoring}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy}\PY{l+s+s1}{\PYZsq{}}
    \PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}
    \PY{n}{precision} \PY{o}{=} \PY{n}{precision\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{sgd\PYZus{}preds}\PY{p}{)}\PY{p}{,}
    \PY{n}{recall} \PY{o}{=} \PY{n}{recall\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{sgd\PYZus{}preds}\PY{p}{)}\PY{p}{,}
    \PY{n}{f1} \PY{o}{=} \PY{n}{f1\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{sgd\PYZus{}preds}\PY{p}{)}\PY{p}{,}
\PY{p}{)}

\PY{n}{sgd\PYZus{}metrics}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Evaluate model \PYZsh{}2...}

\PY{n}{forest\PYZus{}preds} \PY{o}{=} \PY{n}{forest\PYZus{}clf}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{test\PYZus{}x}\PY{p}{)}

\PY{n}{forest\PYZus{}metrics} \PY{o}{=} \PY{n+nb}{dict}\PY{p}{(}
    \PY{n}{model} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Random Forest Classifier}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{n}{accuracy} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{cross\PYZus{}val\PYZus{}score}\PY{p}{(}
        \PY{n}{forest\PYZus{}clf}\PY{p}{,} \PY{n}{test\PYZus{}x}\PY{p}{,} \PY{n}{test\PYZus{}y}\PY{p}{,} 
        \PY{n}{cv}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{scoring}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy}\PY{l+s+s1}{\PYZsq{}}
    \PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}
    \PY{n}{precision} \PY{o}{=} \PY{n}{precision\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{forest\PYZus{}preds}\PY{p}{)}\PY{p}{,}
    \PY{n}{recall} \PY{o}{=} \PY{n}{recall\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{forest\PYZus{}preds}\PY{p}{)}\PY{p}{,}
    \PY{n}{f1} \PY{o}{=} \PY{n}{f1\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{forest\PYZus{}preds}\PY{p}{)}\PY{p}{,}
\PY{p}{)}

\PY{n}{forest\PYZus{}metrics}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Evaluate model \PYZsh{}3...}

\PY{n}{svm\PYZus{}preds} \PY{o}{=} \PY{n}{svm\PYZus{}clf}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{test\PYZus{}x}\PY{p}{)}

\PY{n}{svm\PYZus{}metrics} \PY{o}{=} \PY{n+nb}{dict}\PY{p}{(}
    \PY{n}{model} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Support Vector Machine}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{n}{accuracy} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{cross\PYZus{}val\PYZus{}score}\PY{p}{(}
        \PY{n}{svm\PYZus{}clf}\PY{p}{,} \PY{n}{test\PYZus{}x}\PY{p}{,} \PY{n}{test\PYZus{}y}\PY{p}{,} 
        \PY{n}{cv}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{scoring}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy}\PY{l+s+s1}{\PYZsq{}}
    \PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}
    \PY{n}{precision} \PY{o}{=} \PY{n}{precision\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{svm\PYZus{}preds}\PY{p}{)}\PY{p}{,}
    \PY{n}{recall} \PY{o}{=} \PY{n}{recall\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{svm\PYZus{}preds}\PY{p}{)}\PY{p}{,}
    \PY{n}{f1} \PY{o}{=} \PY{n}{f1\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{svm\PYZus{}preds}\PY{p}{)}\PY{p}{,}
\PY{p}{)}

\PY{n}{svm\PYZus{}metrics}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Evaluate model \PYZsh{}4...}

\PY{n}{knn\PYZus{}preds} \PY{o}{=} \PY{n}{knn\PYZus{}clf}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{test\PYZus{}x}\PY{p}{)}

\PY{n}{knn\PYZus{}metrics} \PY{o}{=} \PY{n+nb}{dict}\PY{p}{(}
    \PY{n}{model} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{K\PYZhy{}Neighbors Classifier}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{n}{accuracy} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{cross\PYZus{}val\PYZus{}score}\PY{p}{(}
        \PY{n}{knn\PYZus{}clf}\PY{p}{,} \PY{n}{test\PYZus{}x}\PY{p}{,} \PY{n}{test\PYZus{}y}\PY{p}{,} 
        \PY{n}{cv}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{scoring}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy}\PY{l+s+s1}{\PYZsq{}}
    \PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}
    \PY{n}{precision} \PY{o}{=} \PY{n}{precision\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{knn\PYZus{}preds}\PY{p}{)}\PY{p}{,}
    \PY{n}{recall} \PY{o}{=} \PY{n}{recall\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{knn\PYZus{}preds}\PY{p}{)}\PY{p}{,}
    \PY{n}{f1} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{f1\PYZus{}score}\PY{p}{(}\PY{n}{test\PYZus{}y}\PY{p}{,} \PY{n}{knn\PYZus{}preds}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}
\PY{p}{)}

\PY{n}{knn\PYZus{}metrics}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{metrics\PYZus{}df} \PY{o}{=}  \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}
    \PY{p}{[}\PY{n}{sgd\PYZus{}metrics}\PY{p}{,} \PY{n}{forest\PYZus{}metrics}\PY{p}{,} \PY{n}{svm\PYZus{}metrics}\PY{p}{,} \PY{n}{knn\PYZus{}metrics}\PY{p}{]}
\PY{p}{)}
